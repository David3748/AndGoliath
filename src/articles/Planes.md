...
What I want this post to be is an invitation to look from a different perspective. For you to _see_ what I see every time I'm on a plane that takes off. That whatever might be happening on a micro scale, on a macro scale what we — a bunch of overgrown apes — have built is nothing short of a miracle.
